...
//Get All Courses
router.get('/allCourses', authenticateToken, async (req, res) => {
  console.log("\x1b[35m*******************Get All Services Route\x1b[0m");
...
router.get('/service/course/:id', authenticateToken, async (req, res) => {
...
//add service
router.post('/', authenticateToken, multer({ storage: multerConfig }).single('img'), async (req, res) => {
